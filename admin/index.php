...
// Query ambil data pesanan (Diurutkan dari yang terbaru berdasarkan ID)
                    ...
                    <?php if (mysqli_num_rows($pesanan) > 0) { ?>
                        <?php while ($row_pesanan = mysqli_fetch_assoc($pesanan)) { ?>
                            <div class="row order-item align-items-center mb-3">
                                ...
                                <div class="col-md-4 action-btns">
                                    <a href="detail_pesanan.php?id=<?= $row_pesanan['id']; ?>" class="btn btn-dark btn-sm">Detail</a>
                                    <a href="konfirmasi_pesanan.php?id=<?= $row_pesanan['id']; ?>" class="btn btn-outline-dark btn-sm">Konfirmasi</a>
                                </div>
                            </div>
                        <?php } ?>
                    <?php } else { ?>
